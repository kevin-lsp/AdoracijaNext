...
const features = [
  {
    ...
    description:
      'Tiho češčenje Jezusa, prisotnega v Evharistiji. Beseda "adorare" pomeni globoko čast in občudovanje.',
  ...
  },
  {
    ...
    description:
      "Intimno srečanje z Bogom. Izmenjava ljubezni z Jezusom in poslušanje Njegovega glasu v tišini.",
  ...
  },
  {
    ...
    description:
      "Bog nas tolažip zdravi in obnavlja. Odpira naša srca, veča ljubezen in daje novo upanje.",
                  ...
                  >
                    ...
                    <div className="bg-cream p-6 rounded-2xl border-l-4 border-gold">
                      <p className="font-display text-lg italic text-navy/80">
                        {index === 0 &&
                          '"V tišini pred Bogom najdemo mir, ki presega vse razumevanje."'}
                        {index === 1 &&
                          '"Srečanje z Jezusom v adoraciji spremeni naše srce."'}
                        {index === 2 &&
                          '"Bog nas zdravi in obnavlja v svoji prisotnosti."'}
                      </p>
                    </div>
                  </motion.div>
                </div>
