...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      {/* Main Title - Centered */}
      <div className="relative z-10 flex-1 flex justify-center text-center px-4 pt-20 md:pt-32">
        <h1
          className="font-display text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-semibold text-white animate-fade-up tracking-wide italic"
          style={{
            textShadow: `
      ...
      <div className="relative z-10 text-center pb-8 md:pb-24 px-6">
        <div className="max-w-2xl mx-auto md:mx-0">
          <p
            className="font-display text-lg sm:text-xl md:text-2xl lg:text-3xl text-white italic leading-relaxed mb-3"
            style={{
              textShadow: `
